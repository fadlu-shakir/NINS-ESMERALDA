        ...
        <div className="row">
          <div className="col-lg-4 mb-4 mb-lg-0">
            ...
            <div className="d-flex gap-3 mt-4">
              ...
              <a href="https://www.instagram.com/esmeraldaresort_?igsh=MXNxNzExZ3M2cm5tcw==" className="fs-5"><i className="fab fa-instagram"></i></a>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <ul className="list-unstyled mt-3">
              ...
              <li className="mb-3"><i className="fas fa-phone me-2 text-accent"></i> +91 98765 43210</li>
              <li className="mb-3"><i className="fas fa-envelope me-2 text-accent"></i> ninsesmeralda@gmail.com</li>
            </ul>
          </div>
        </div>
